...
class MockResolutionService:
    ...
    async def resolve_best(
        ...
        """Оценивает кандидатов на соответствие запросу и возвращает наиболее подходящий мок.

        Args:
            request_context: Контекст входящего запроса, содержащий метод, путь и другие данные запроса.
            candidates: Список кандидатов на мок, которые соответствуют методу, пути и scope.
    ...
    async def evaluate_candidates(
        ...
        Returns:
            ...
            о соответствии каждого кандидата запросу и его ранг среди подходящих кандидатов.
        """
